...
const IntegrationCard = ({ description, icon, strategy, title }:Props) => {
    ...
    return (
        <div className="border-2 border-[#7851A9] rounded-2xl gap-x-5 p-5 flex items-center">
            {icon}
            ...
            <Button
               ...
               // disabled={integrated?.name === strategy}
                className="bg-gradient-to-br text-white rounded-full text-lg from-[#3352CC] font-medium to-[#1C2D70]
